...
RECAPTCHA_SCORES = {
    "login": env.float("RECAPTCHA_LOGIN_SCORE", RECAPTCHA_REQUIRED_SCORE),
    "signup": env.float("RECAPTCHA_SIGNUP_SCORE", RECAPTCHA_REQUIRED_SCORE),
    "reset_password": env.float("RECAPTCHA_RESET_SCORE", RECAPTCHA_REQUIRED_SCORE),
    "add_email": env.float("RECAPTCHA_EMAIL_SCORE", RECAPTCHA_REQUIRED_SCORE),
}
